...
export default function AgencyLogin() {
  ...
  const onSubmit = (e: React.FormEvent) => { e.preventDefault(); alert("MVP login: access will be logged on backend later."); };
    ...
    <main className="mx-auto max-w-md p-6 md:p-10">
      <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
        ...
        <form onSubmit={onSubmit} className="mt-5 space-y-4">
          <label className="text-sm block"><span className="block font-medium mb-1">Email</span>
          ...
          <label className="text-sm block"><span className="block font-medium mb-1">Passcode</span>
